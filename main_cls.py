...
from model import PointNet, DFA_cls
import numpy as np
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='dfa', metavar='N',choices=['pointnet', 'dfa'],
                        help='Model to use, [pointnet, dfa]')
